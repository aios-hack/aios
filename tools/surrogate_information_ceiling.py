"""Информационный потолок признаков расписания — почему инженерия исчерпана.
...
Вывод: признаки из расписания и истории упёрлись в потолок, и сдвинуть его
может только новая информация — прогоны OPM на manifold оптимизатора.
