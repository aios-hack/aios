...
from backend.ml.surrogate.model import TrajectorySurrogate, TrainingExample, target_mae, _legacy_checkpoint_modules
...
from backend.presentation.cli.surrogate_adapt import errors, sample_scenarios
...
def main(argv=None):
    ...
    result = json.loads((args.experiment / "result.json").read_text())
