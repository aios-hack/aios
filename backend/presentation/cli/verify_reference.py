...
from backend.infrastructure.resources import model_z_dir, chdd_python_dir, normatives_xlsx
...
def main(argv=None):
    ...
    measured = json.loads((run / "economics/result.json").read_text())["measured_npv"]
