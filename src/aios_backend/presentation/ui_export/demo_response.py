...
from aios_backend.core.contracts import ActiveControlMode, IntervalResponse, Role, StateAtDate

from aios_backend.presentation.ui_export.demo_rng import Rng
        ...
        for well in wells:
            ...
            rows.append(
                IntervalResponse(
                    control_step=step,
                    well=well,
                    oil_mass_delta=round(liquid * oil_share[well] * decline * 0.86, 2),
