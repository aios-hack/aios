...
from aios_backend.core.contracts import T0, content_hash
from aios_backend.domain.schedule import LosslessEmitter, parse_schedule
from aios_backend.domain.schedule.emit import (
...
def test_broken_round_trip_is_reported_and_raised() -> None:
    from aios_backend.domain.schedule.emit import RoundTripReport
