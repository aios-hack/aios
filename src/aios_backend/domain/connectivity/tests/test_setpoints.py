...
from aios_backend.core.contracts import Role, T0

from aios_backend.domain.connectivity import DeckSchedule, setpoint_changes
...
def test_relative_step_from_zero_level_is_rejected(injection) -> None:
    from aios_backend.domain.connectivity import SetpointChange
