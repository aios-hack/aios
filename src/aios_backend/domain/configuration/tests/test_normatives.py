...
from aios_backend.core.contracts import DEFAULT_NORMATIVES_2007, NormativeSet
...
from aios_backend.domain.configuration.normatives import METHODOLOGY_LOCKED
