...
from aios_backend.core.contracts import ArtifactHashes, Budgets, NormativeSet

from aios_backend.domain.configuration import COMPONENT_SEEDS, GLOBAL_SEED_KEY
from aios_backend.domain.configuration.schema import DEFAULT_BUDGETS, default_seeds
...
def test_every_normative_field_is_reachable_from_the_config() -> None:
    from aios_backend.domain.configuration.tests.conftest import a_hash

    from aios_backend.domain.configuration import default_config
    from aios_backend.core.contracts import DEFAULT_NORMATIVES_2007
