...
from aios_backend.core.contracts import MAX_LRAT_M3_PER_DAY, EventKind, Rule

from aios_backend.domain.policy import RuleContext, RuleFlags, apply_rule, make_theta
from aios_backend.domain.policy.rules import r2
from aios_backend.domain.policy.tests.conftest import producer, state_of
