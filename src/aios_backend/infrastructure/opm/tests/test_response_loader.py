...
from aios_backend.infrastructure.opm import OpmRunner
from aios_backend.infrastructure.opm.response_loader import (
    _ELEMENTS_PER_BLOCK,
    ResponseLoader,
    ResponseLoaderError,
...
from aios_backend.infrastructure.opm.summary import SummaryConnection, SummaryPlan
...
def _nums(k: int, _unused: int, smspec) -> int:
    ...
    from aios_backend.infrastructure.opm.summary import _grid_index
