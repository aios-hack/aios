...
from aios_backend.infrastructure.opm import SubmissionTractError, submit_schedule
from aios_backend.infrastructure.opm.cache import cache_key
...
from aios_backend.infrastructure.opm.submission import _run
from aios_backend.domain.configuration import default_config, economics_config_hash
...
from aios_backend.domain.economics import ESP_CATALOG_2007, methodology_version_hash
...
from aios_backend.domain.schedule.build import deck_well_axis, initial_state_from_prefix
...
def test_opm_run_canonical_schedule_hash_matches_recomputed(schedule, run_and_response) -> None:
    ...
    from aios_backend.core.contracts import hash_schedule
...
def final_npv(schedule, config, run_and_response):
    ...
    from aios_backend.core.contracts import FinalNpvArtifact
