...
const ru = toNamespaces(import.meta.glob('../../../frontend/src/shared/i18n/locales/ru/*.json', { eager: true }));
const en = toNamespaces(import.meta.glob('../../../frontend/src/shared/i18n/locales/en/*.json', { eager: true }));
...
const sources = import.meta.glob('../../../frontend/src/**/*.{ts,tsx}', {
  eager: true,
  query: '?raw',
  import: 'default'
