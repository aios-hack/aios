...
import type { GraphEdge, GraphFile, GraphNode } from '@/entities/graph/types';
import { EDGE_WIDTH_FLAT } from '@/shared/theme/tokens';
import {
  DEFAULT_EDGE_BUDGET,
  EDGES_PER_PRODUCER,
  buildSelection,
  ...
  topEdgesPerProducer,
  visibleEdges
} from '@/entities/graph/model/graphModel';
