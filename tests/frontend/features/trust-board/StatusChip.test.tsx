...
import type { ScenarioConstraintsSummary, ScenarioEntry, ScenariosFile } from '@/entities/scenarios/types';
...
import { StatusChip } from '@/features/trust-board/ui/StatusChip/StatusChip';
