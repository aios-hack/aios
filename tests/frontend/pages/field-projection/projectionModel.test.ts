...
import type { LayerRange, WellPoint, WellsFile } from '@/entities/wells/types';
import {
  dimmedWellIds,
  isWellDimmed,
  layerOptions,
...
import {
  ...
  type LabelledPoint,
  type ProjectedNode
} from '@/entities/graph/model/interpolate';
import { coalescedZoom, FRAME_BUDGET_MS, shouldCommitFrame, ZOOM_STEP } from '@/entities/graph/model/useProjection';
