...
class ViolationKind(Enum):
    ...
    COMPENSATION_BELOW_TARGET = "COMPENSATION_BELOW_TARGET"
    COMPENSATION_ABOVE_TARGET = "COMPENSATION_ABOVE_TARGET"
    COMPENSATION_TARGET_UNREACHABLE = "COMPENSATION_TARGET_UNREACHABLE"
    COMPENSATION_BELOW_HARD_LIMIT = "COMPENSATION_BELOW_HARD_LIMIT"
    COMPENSATION_ABOVE_HARD_LIMIT = "COMPENSATION_ABOVE_HARD_LIMIT"
