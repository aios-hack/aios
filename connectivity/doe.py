...
from connectivity.fund import ActiveFund, Window
from connectivity.hadamard import hadamard, is_hadamard, normalized
from connectivity.setpoints import StepDistribution
