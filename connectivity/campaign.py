...
from connectivity.deck import parse_deck_schedule
from connectivity.doe import Amplitude, DoEPlan, Level, amplitude_from_prior, plackett_burman
from connectivity.fund import ActiveFund, Window, active_fund_in_window, build_fund_history
...
#: Две независимые партии плана — устойчивость λ иначе не меряется (§8.2).
DEFAULT_BATCH_SEEDS = (20260820, 20260821)
