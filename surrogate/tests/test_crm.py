...
from contracts import IntervalResponse, N_INTERVALS, RunResult, RunStatus
from schedule import load_schedule
from surrogate.crm import (
    BaselineComparison,
    CrmBaseline,
    CrmError,
    CrmSplit,
...
def _load_real_response():
    ...
    return loader_module.ResponseLoader().load(run_result, plan, schedule, density)
