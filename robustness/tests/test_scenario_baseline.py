"""Приёмка задачи 42 (docs/assignments/ivan.md, docs/context/08_contracts.md §13.1, §13.3).
...
from contracts import Constraints, OptimizerResult, Theta

from robustness import FragilityBattery, Split, holdout_view, optimization_view
from robustness.battery import Scenario
