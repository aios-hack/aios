...
import { formatNumber, formatStepDate } from '@/shared/lib/format';
import { indexFromRatio, panelGeometry, yearTicks } from '@/entities/timeline/ui/MainChart/chartGeometry';
