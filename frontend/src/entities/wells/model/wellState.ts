...
import { actualRate } from '@/entities/timeline/model/wellRow';
import { areaRadius, ratioColor, watercutColor } from '@/shared/theme/scales';
...
export const rowsAtStep = (
  ...
  const bounded = clamp(stepIndex, 0, timeline.steps.length - 1);
