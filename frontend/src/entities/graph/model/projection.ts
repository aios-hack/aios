...
import type { GraphEdge, GraphFile } from '@/entities/graph/types';
...
import { npvByWell, npvCeilingOf } from '@/entities/wells/model/wellFacts';
import {
  rateCeiling,
  rowsAtStep,
  wellStateOf,
  type WellState
} from '@/entities/wells/model/wellState';
import { defaultThreshold, visibleEdges } from '@/entities/graph/model/graphModel';
import { fitLayout, placeNodes, type Box, type ProjectedNode } from '@/entities/graph/model/interpolate';
