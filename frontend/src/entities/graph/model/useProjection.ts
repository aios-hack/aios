...
import { createViewBox, useViewBox } from '@/shared/lib/viewbox/useViewBox';
import { easeInOut } from '@/entities/graph/model/interpolate';
import { FIELD_PAD, FIELD_SIZE } from '@/entities/graph/model/projection';
