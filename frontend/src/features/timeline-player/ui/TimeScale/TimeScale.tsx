...
import { PlaybackSettings } from '@/features/timeline-player/ui/PlaybackSettings';
import { StepControls } from '@/features/timeline-player/ui/StepControls/StepControls';
import { eventMarks, fieldEvents, yearTicks } from '@/entities/events/derive';
import { TimeScaleTrack } from '@/features/timeline-player/ui/TimeScaleTrack/TimeScaleTrack';
import { useBackdropMorph } from '@/features/timeline-player/model/useBackdropMorph';
import { useAxisCollapse } from '@/features/timeline-player/model/axis';
import { useBackdropShape } from '@/features/timeline-player/model/useBackdropShape';
import { useHotkeys } from '@/features/timeline-player/model/useHotkeys';
import { playIntervalMs, useStepPlayback } from '@/features/timeline-player/model/useStepPlayback';
