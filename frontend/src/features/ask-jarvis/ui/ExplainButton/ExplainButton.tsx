...
import { useExplainAction } from '@/jarvis/actions/lib/useExplainAction';
...
export const ExplainButton = ({ well, step, compact = false }: ExplainButtonProps) => {
  ...
  return (
    <button
      ...
      title={t('jarvis-stage.explainHint')}
      aria-label={t('jarvis-stage.explainQuestion', { well })}
      onClick={onClick}
    >
      {t('jarvis-stage.explain')}
    </button>
  );
};
