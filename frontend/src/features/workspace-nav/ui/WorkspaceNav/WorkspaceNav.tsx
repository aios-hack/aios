...
import { JarvisLauncher } from '@/jarvis/stage/JarvisLauncher/JarvisLauncher';
import { useT } from '@/shared/i18n/I18nContext';
import { type Workspace } from '@/shared/router/routes';
import { useRoute } from '@/shared/router/RouterProvider';
import { useRovingTabs } from '@/shared/lib/keyboard/useRovingTabs';
import './WorkspaceNav.css';

export const WorkspaceNav = () => {
  const t = useT();
  const { workspaces, workspace, setWorkspace } = useRoute();
