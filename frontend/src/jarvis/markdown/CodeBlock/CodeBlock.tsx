...
import { highlight, languageOf } from '@/jarvis/markdown/lib/highlight';
    ...
    <figure className="jarvis-md-code">
      <figcaption className="jarvis-md-code-head">
        <span className="jarvis-md-code-lang">
          {lang.trim().length === 0 ? t('jarvis-cards.codePlain') : lang.trim()}
        </span>
        <button
          type="button"
        ...
        >
          <span aria-live="polite">{copied ? t('jarvis-cards.copied') : t('jarvis-cards.copy')}</span>
        </button>
      </figcaption>
