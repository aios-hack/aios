import type { GlossaryPayload, GuidePayload } from '@/jarvis/cards/payloads/payloadTypes';
import { isRecord, isStr, list, strOrNull, textOf } from '@/jarvis/cards/payloads/payloadPrimitives';
