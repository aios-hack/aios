  ...
  return (
    <div className="jarvis-guide">
      <p className="jarvis-guide-block">
        <span className="jarvis-guide-label">{t('jarvis-cards.guideWhat')}</span>
        {guide.what}
      </p>
      {guide.how_to_read.length === 0 ? null : (
        <p className="jarvis-guide-block">
          <span className="jarvis-guide-label">{t('jarvis-cards.guideHowToRead')}</span>
          {guide.how_to_read}
        </p>
      )}
      {guide.controls.length === 0 ? null : (
        <div className="jarvis-guide-controls">
          <p className="jarvis-guide-label">{t('jarvis-cards.guideControls')}</p>
          <ul>
      ...
      {guide.questions.length === 0 ? null : (
        <p className="jarvis-guide-questions">
          <span className="jarvis-guide-label">{t('jarvis-cards.guideQuestions')}</span>
