...
import type { MapLayerFile, MapScale, MapsIndexFile } from '../../api/types';
import { clamp01 } from '../../theme/scales';
import { mixColors, readCssColor, readPalette, type Rgb } from '../shared/canvasColors';
import { categoryCount, categoryIndex, QUANT_MAX } from './mapModel';
