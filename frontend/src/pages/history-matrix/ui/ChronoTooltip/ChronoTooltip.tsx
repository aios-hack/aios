...
import { DASH, formatNumber, formatPercent, formatStepDate } from '@/shared/lib/format';
import type { ChronoMetric } from '@/pages/history-matrix/model/cells';
import { modeOf } from '@/pages/history-matrix/model/cells';
import { readingText } from '@/pages/history-matrix/model/readings';
import './ChronoTooltip.css';
