...
import { MIN_RADIUS, type WellState } from '@/entities/wells/model/wellState';
import { SelectionRings } from '@/entities/wells/ui/SelectionRings/SelectionRings';
import type { SelectionHighlight } from '@/entities/wells/model/useSelectionHighlight';
import type { PlacedNode } from '@/entities/graph/model/interpolate';
import type { NodeHover } from '@/pages/field-projection/ui/NodeTooltip/NodeTooltip';
