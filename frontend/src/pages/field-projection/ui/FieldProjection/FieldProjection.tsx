...
import { dimmedWellIds, shownCount, type LayerFilter } from '@/pages/field-projection/model/layerFilter';
import { useProjectionGeometry, useWellStates } from '@/entities/graph/model/projection';
import { NodeLayer } from '@/pages/field-projection/ui/NodeLayer/NodeLayer';
import { NodeTooltip, type NodeHover } from '@/pages/field-projection/ui/NodeTooltip/NodeTooltip';
import { ProjectionControls, type ProjectionPole } from '@/pages/field-projection/ui/ProjectionControls/ProjectionControls';
