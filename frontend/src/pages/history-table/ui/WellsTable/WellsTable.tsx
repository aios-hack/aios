...
import { SortableHeader } from '@/pages/history-table/ui/SortableHeader/SortableHeader';
import { isNumericKey, SORT_KEYS, sortWells, type SortDir, type SortKey } from '@/pages/history-table/model/sorting';
import { WellRow } from '@/pages/history-table/ui/WellRow/WellRow';
