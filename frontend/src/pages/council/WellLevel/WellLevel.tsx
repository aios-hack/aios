...
import type { CouncilPath, WellRow as WellRowData } from '@/pages/council/levels';
import { WellRow } from '@/pages/council/WellRow/WellRow';
import { WellSortHeader } from '@/pages/council/WellSortHeader/WellSortHeader';
import {
  isNumericWellKey,
  sortWellRows,
  WELL_SORT_KEYS,
