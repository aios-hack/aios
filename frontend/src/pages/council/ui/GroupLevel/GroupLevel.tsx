...
import type { HierarchyGroupAllocation, HierarchyStep } from '@/entities/hierarchy/types';
import { useI18n } from '@/shared/i18n/I18nContext';
import { DASH, formatNumber, formatPercent } from '@/shared/lib/format';
import { dimState, type CouncilPath, type FieldSegment, type GroupCard } from '@/pages/council/model/levels';
        ...
        {cards.map((card, index) => {
          ...
          return (
            ...
            >
              <button
                type="button"
                className="council-column-pick focus-on-fill"
