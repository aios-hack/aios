...
import type { CouncilPath, WellRow as WellRowData } from '@/pages/council/model/levels';
import { WellRow } from '@/pages/council/ui/WellRow/WellRow';
import { WellSortHeader } from '@/pages/council/ui/WellSortHeader/WellSortHeader';
import {
  isNumericWellKey,
  sortWellRows,
  WELL_SORT_KEYS,
