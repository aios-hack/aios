import type { HierarchyFile, HierarchyGroupAllocation, HierarchyGroupLevel, HierarchyStep, HierarchyWellDecision } from '@/entities/hierarchy/types';
import { groupColor } from '@/shared/theme/tokens';
