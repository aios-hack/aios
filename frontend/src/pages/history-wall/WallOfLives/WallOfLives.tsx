...
import { layoutOf, stepAt, tileIndexAt, tileX } from '@/pages/history-wall/layout';
import {
  buildSeries,
  seriesCeiling,
  useWallPalette,
...
import { useWallCanvas, useWallCursor } from '@/pages/history-wall/useWallCanvas';
import { WallControls } from '@/pages/history-wall/WallControls/WallControls';
