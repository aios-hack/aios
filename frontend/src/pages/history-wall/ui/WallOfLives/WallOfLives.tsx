...
import { wallMarkColors } from '@/shared/theme/tokens';
...
import { toCanvasColor } from '@/shared/lib/canvas/canvasColors';
import { useCellKeyboard } from '@/shared/lib/keyboard/useCellKeyboard';
import { groupByWell, npvByWell } from '@/entities/wells/model/wellFacts';
import { layoutOf, stepAt, tileIndexAt, tileX } from '@/pages/history-wall/model/layout';
import {
  buildSeries,
  seriesCeiling,
  useWallPalette,
...
import { useContainerBox } from '@/shared/lib/layout/useContainerBox';
import { useWallCanvas, useWallCursor } from '@/pages/history-wall/model/useWallCanvas';
import { WallControls } from '@/pages/history-wall/ui/WallControls/WallControls';
