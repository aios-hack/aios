...
import { bandGeometry, buildSparkline } from '@/shared/ui/Sparkline/series';
import { yearTicks } from '@/entities/events/derive';
import { DASH } from '@/shared/lib/format';
import type { OverviewMetric, OverviewMetricKey } from '@/pages/overview/model/overviewMetrics';
