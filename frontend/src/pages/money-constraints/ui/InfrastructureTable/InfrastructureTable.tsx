...
import { INFRASTRUCTURE_PARAMETERS } from '@/pages/money-constraints/model/infrastructureParameters';
import { useT } from '@/shared/i18n/I18nContext';
import type { FieldError, PairRow } from '@/pages/money-constraints/model/constraints';
