...
import { AblationTable } from '@/pages/money-rank/ui/AblationTable/AblationTable';
import { NpvTable } from '@/pages/money-rank/ui/NpvTable/NpvTable';
import { TaxModeSwitch } from '@/pages/money-rank/ui/TaxModeSwitch/TaxModeSwitch';
import type { NpvSortKey, SortDir, TaxMode } from '@/pages/money-rank/model/types';
import './NpvRank.css';
import './NpvTotals.css';
