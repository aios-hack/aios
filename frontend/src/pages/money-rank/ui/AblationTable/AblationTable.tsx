...
import { coverageOf, leadRatio, toEntries } from '@/pages/money-rank/model/ablation';
import { AblationRow } from '@/pages/money-rank/ui/AblationRow/AblationRow';
import {
...
import './AblationSummary.css';
import './AblationTable.css';
import './AblationCells.css';
    ...
    <section className="abl" aria-labelledby="abl-title" data-standalone={standalone}>
      <header className="abl-head">
        <div className="abl-headline">
          <h3
            className={standalone ? 'abl-title abl-standalone-title' : 'abl-title'}
            id="abl-title"
          >
