...
import { NpvProvenanceTag } from '@/pages/money-rank/NpvProvenanceTag/NpvProvenanceTag';
import { npvProvenanceOf, type ArtifactProvenance } from '@/pages/money-comparison/provenance';
