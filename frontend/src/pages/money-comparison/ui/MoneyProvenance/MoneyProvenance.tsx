...
import { NpvProvenanceTag } from '@/pages/money-rank/ui/NpvProvenanceTag/NpvProvenanceTag';
import { npvProvenanceOf, type ArtifactProvenance } from '@/pages/money-comparison/model/provenance';
