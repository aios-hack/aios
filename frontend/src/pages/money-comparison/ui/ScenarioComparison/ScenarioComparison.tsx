...
import type { TaxMode } from '@/pages/money-rank/model/types';
import { alternativesOf, compareScenarios, submittedOf, valueFor } from '@/pages/money-comparison/model/comparison';
